...
# feature_maps = torch.randn(16, 32, 80, 80) # shape (batch_size, num_channels, height, width)
# glam = GLAM(in_channels=16, num_reduced_channels=16, feature_map_size=80, kernel_size=3)

# # glam(feature_maps) # shape (16, 32, 8, 8), same as input
# torchinfo.summary(glam,(1,16,80,80))
